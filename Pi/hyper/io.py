...
class Input:
    def __init__(self):
        ...
        self.voltmeter = Sensor(11, comm_port)
        self.ammeter = Sensor(7, comm_port)
        self.prox1 = Sensor(20, comm_port)
        self.prox2 = Sensor(21, comm_port)
        self.prox3 = Sensor(22, comm_port)
        self.prox4 = Sensor(23, comm_port)
        self.retro1 = Sensor(24, comm_port)
        self.retro2 = Sensor(25, comm_port)
        self.lf_lev_pot = Sensor(3, comm_port)
        self.rf_lev_pot = Sensor(4, comm_port)
        self.lb_lev_pot = Sensor(5, comm_port)
        self.rb_lev_pot = Sensor(6, comm_port)
        self.lf_lat_pot = Sensor(1, comm_port)
        self.rf_lat_pot = Sensor(2, comm_port)
        self.lb_lat_pot = Sensor(16, comm_port)
        self.rb_lat_pot = Sensor(17, comm_port)
        self.l_ebr_pot = Sensor(10, comm_port)
        self.r_ebr_pot = Sensor(9, comm_port)
